...
#include "qSlicerDependentExtensionModuleWidgetsExport.h"

class qSlicerFooBarWidgetPrivate;

/// \ingroup Slicer_QtModules_DependentExtension
class Q_SLICER_MODULE_DEPENDENTEXTENSION_WIDGETS_EXPORT qSlicerFooBarWidget
  : public QWidget
{
  Q_OBJECT
public:
